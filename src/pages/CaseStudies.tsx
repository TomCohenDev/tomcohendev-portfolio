...
const CaseStudies = () => {
  ...
  return (
    <div className="min-h-screen">
      <Header />
      <main className="text-[#E0D0C1] overflow-hidden font-nunito">
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="relative pt-32 pb-24 text-center">
                <div className="relative z-10 max-w-4xl mx-auto px-4">
                  <h1 className="excalifont-title text-5xl md:text-7xl lg:text-8xl font-bold text-[#E0D0C1] mb-8 leading-[1.1] tracking-tight">
                    Real Problems. <br />
                    <span
                  ...
                  <p className="text-xl md:text-2xl text-[#B9BBBE] leading-relaxed max-w-2xl mx-auto">
                    We bridge the gap between complex requirements and simple
                    user experiences. Explore how we've helped founders,
                    startups, individuals and scale-ups across all industries
                    scale their visions.
                  </p>
                </div>
              </div>

              {/* Gomlin Jobs Case Study */}
              <div className="flex flex-col lg:flex-row lg:gap-12 items-center py-24">
                  ...
                  <div className="hidden lg:block space-y-8">
                    <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
                      <p>
                        ...
                        Employers spend hours wading through endless résumés,
                        while freelancers waste time on cold outreach and sales
                        pitches.
                      </p>
                      <p>
                        We built <strong>Gomlin Jobs</strong>—a dual-platform
                        job matching ecosystem with AI-powered SmartMatch™
                        technology, featuring a web platform for employers and a
                        Tinder-style mobile app for job seekers.
                      </p>
                    </div>
                ...
                <div className="lg:w-1/2 w-full order-2 lg:order-2 mb-20 lg:mb-0 relative">
                  <div className="absolute inset-0 bg-[#bf95f9]/10 blur-[100px] rounded-full pointer-events-none"></div>
              ...
              <div className="flex flex-col lg:flex-row lg:gap-12 items-center py-24 border-t border-white/5">
                {/* Left Image/Visual - The Automation Hub */}
                <div className="lg:w-1/2 w-full order-2 lg:order-1 mb-20 lg:mb-0 relative">
                  {/* Glow effect */}
                  <div className="absolute inset-0 bg-[#d946ef]/10 blur-[100px] rounded-full pointer-events-none"></div>
                  <div className="relative w-full max-w-xl mx-auto min-h-[450px] flex items-center justify-center">
                    ...
                    >
                      <svg
                        ...
                        style={{
                          transform: "scale(1.0) translate(-20%, -15%)",
                        }}
                      >
                        <g
                ...
                <div className="lg:w-1/2 w-full space-y-8 order-1 lg:order-2">
                  ...
                  <div className="hidden lg:block space-y-8">
                    <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
                      <p>
                        Nightwing restaurant was drowning in manual order entry
                        and phone calls. They needed a cost-effective solution
                        that eliminated human error and saved them from hiring a
                        dedicated call taker.
                      </p>
                      <p>
                        We built a bilingual (Hebrew/English) online ordering
                        system with n8n automation that processes orders, logs
                        to Google Sheets, and sends instant Telegram
                        notifications—all without a single line of backend code.
                      </p>
                    </div>
                ...
                <div className="lg:hidden w-full order-3 space-y-8">
                  <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
                    ...
                    <p>
                      We built a bilingual (Hebrew/English) online ordering
                      system with n8n automation that processes orders, logs to
                      Google Sheets, and sends instant Telegram
                      notifications—all without a single line of backend code.
                    </p>
                  </div>
              ...
              <div className="flex flex-col lg:flex-row lg:gap-12 items-center py-24 border-t border-white/5">
                  ...
                  <div className="hidden lg:block space-y-8">
                    <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
                      <p>
                        ...
                        personal brand requires consistency, but the manual
                        process was brutal: constantly monitoring sources for
                        relevant content, filtering through noise, and crafting
                        posts that actually sound like you.
                      </p>
                      <p>
                        We built an autonomous AI agent that aggregates content
                        from your chosen sources, filters for relevance, and
                        generates social posts in your exact voice—reducing
                        content creation time by 95%.
                      </p>
                    </div>
                ...
                <div className="lg:w-1/2 w-full order-2 lg:order-2 mb-20 lg:mb-0 relative">
                  {/* Glow effect */}
                  <div className="absolute inset-0 bg-[#6366f1]/10 blur-[100px] rounded-full pointer-events-none"></div>
                        ...
                        <div className="flex gap-2">
                          <div className="bg-[#182533] rounded-2xl rounded-tl-sm p-4 max-w-[85%]">
                            ...
                            <p className="text-xs text-gray-300 leading-relaxed mb-2">
                              ...
                              memos into polished blog posts. The future of
                              content creation is voice-first..."
                            </p>
              ...
              <div className="flex flex-col lg:flex-row lg:gap-12 items-center py-24 border-t border-white/5">
                ...
                <div className="lg:w-1/2 w-full order-2 lg:order-1 mb-20 lg:mb-0 relative">
                  {/* Glow effect */}
                  <div className="absolute inset-0 bg-[#a855f7]/10 blur-[100px] rounded-full pointer-events-none"></div>
                  <div className="relative w-full max-w-md mx-auto">
                    <div className="bg-[#0E1621] rounded-2xl overflow-hidden shadow-2xl border border-white/5 font-sans">
                      ...
                      <div className="bg-[#17212B] p-4 flex items-center gap-3 border-b border-black/20">
                        <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#bf95f9] to-[#8b5cf6] flex items-center justify-center text-white font-bold">
                          AI
                        </div>
                        <div>
                ...
                <div className="lg:w-1/2 w-full space-y-8 order-1 lg:order-2">
                  <div className="mb-12 lg:mb-0">
                    ...
                    <h2 className="text-4xl md:text-4xl lg:text-5xl font-bold text-foreground leading-tight">
                      The Zero-UI <br />
                      <span className="text-[#bf95f9]">Content Engine</span>
                    </h2>
                  </div>
                  ...
                  <div className="hidden lg:block space-y-8">
                    <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
                      <p>
                        ...
                        needed a way to dump our brain contents and get a
                        polished result instantly.
                      </p>
                      <p>
                        We built a system that turns raw Telegram messages into
                        fully formatted, SEO-optimized blog posts with generated
                        art—in under 60 seconds. From 4 hours per post to 2
                        minutes.
                      </p>
                    </div>
                    ...
                    <div className="pt-6">
                      <button
                        ...
                        onClick={() =>
                          navigate("/case-studies/blog-automation")
                        }
                      >
              ...
              <div className="flex flex-col lg:flex-row lg:gap-12 items-center py-24 border-t border-white/5">
                ...
                <div className="lg:w-1/2 w-full space-y-8 order-1 lg:order-1">
                  ...
                  <div className="hidden lg:block space-y-8">
                    <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
                      <p>
                        Most productivity tools assume you know how to break
                        down a goal. Psychology shows that ambiguity is the
                        enemy of action.
                      </p>
                      <p>
                        We built a dual-personality AI system that combines
                        behavioral psychology with actionable roadmaps. Mint
                        handles strategy and planning, while Kola provides
                ...
                <div className="lg:hidden w-full order-3 space-y-8">
                  <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
                    ...
                    <p>
                      ...
                      psychology with actionable roadmaps. Mint handles strategy
                      and planning (IQ), while Kola provides motivation and
              ...
              {/* Spidclass Case Study */}
              <div className="flex flex-col lg:flex-row lg:gap-20 items-center py-24 border-t border-white/5">
                {/* Visual: Phone Cascade */}
                <div className="lg:w-1/2 w-full order-2 lg:order-1 relative min-h-[400px] flex items-center justify-center">
                  <div className="relative z-10 transform -rotate-6">
                    <PhoneFrame borderColor="border-slate-800">
                      {/* Mock UI */}
                    ...
                    {/* Floating Element */}
                    <div className="absolute top-20 -right-12 bg-[#1a1a1a] border border-[#bef264]/30 p-4 rounded-xl shadow-xl backdrop-blur-md">
                      <div className="flex items-center gap-3">
                        <Zap
                          size={20}
                          className="text-[#bef264] fill-[#bef264]"
                        />
                        <div>
                ...
                {/* Content */}
                <div className="lg:w-1/2 w-full order-1 lg:order-2 space-y-6 mb-12 lg:mb-0">
                  <div>
                    <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#bef264]/10 border border-[#bef264]/20 rounded-full text-xs font-bold text-[#bef264] mb-6">
                      <Smartphone size={12} /> Featured Case Study
                    </div>
                    <h2 className="text-4xl md:text-5xl font-bold text-white mb-8 lg:mb-4">
              ...
              {/* Yellow Candle Case Study */}
              <div className="flex flex-col lg:flex-row lg:gap-20 items-center py-24 border-t border-white/5">
                {/* Content */}
                <div className="lg:w-1/2 w-full space-y-6 mb-12 lg:mb-0">
                  <div>
                    <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#facc15]/10 border border-[#facc15]/20 rounded-full text-xs font-bold text-[#facc15] mb-6">
                      <Flame size={12} /> Featured Case Study
                    </div>
                    <h2 className="text-4xl md:text-5xl font-bold text-white mb-8 lg:mb-4">
                    ...
                    <p className="text-lg text-[#B9BBBE] leading-relaxed">
                      A digital memorial app serving 14,000+ members worldwide.
                      We modernized the legacy codebase to meet strict new app
                      store compliance while preserving the solemnity of the
                      user experience.
                    </p>
                  </div>
                  <div className="flex flex-wrap gap-2">
                ...
                {/* Visual: Glowing Candle Phone */}
                <div className="lg:w-1/2 w-full relative min-h-[400px] flex items-center justify-center">
              ...
              {/* Portfolio Websites Case Study */}
              <div className="flex flex-col lg:flex-row lg:gap-20 items-center py-24 border-t border-white/5">
                {/* Visual: Performance Browser */}
                <div className="lg:w-1/2 w-full order-2 lg:order-1 relative min-h-[300px] flex items-center justify-center px-4">
                ...
                <div className="lg:w-1/2 w-full order-1 lg:order-2 space-y-6 mb-12 lg:mb-0">
                  <div>
                    <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#38bdf8]/10 border border-[#38bdf8]/20 rounded-full text-xs font-bold text-[#38bdf8] mb-6">
              ...
              <div className="flex flex-col lg:flex-row lg:gap-20 items-center py-24 border-t border-white/5">
                ...
                <div className="lg:w-1/2 w-full space-y-6 mb-12 lg:mb-0">
                  <div>
                    <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#06b6d4]/10 border border-[#06b6d4]/20 rounded-full text-xs font-bold text-[#06b6d4] mb-6">
                    ...
                    <p className="text-lg text-[#B9BBBE] leading-relaxed">
                      ...
                      to "see" educational content on screen and overlay
                ...
                {/* Visual: Code/AI Overlay */}
                <div className="lg:w-1/2 w-full relative min-h-[300px] flex items-center justify-center">
                  <div className="w-full relative z-10 bg-[#0f172a] rounded-lg border border-[#06b6d4]/30 p-1 shadow-2xl">
                    {/* Fake Math Problem Background */}
              ...
              {/* Fullstack Apps Case Study */}
              <div className="flex flex-col lg:flex-row lg:gap-20 items-center py-24 border-t border-white/5">
                {/* Visual: Admin Dashboard */}
                <div className="lg:w-1/2 w-full order-2 lg:order-1 relative min-h-[300px] flex items-center justify-center">
                  <div className="w-full relative z-10 group">
                ...
                <div className="lg:w-1/2 w-full order-1 lg:order-2 space-y-6 mb-12 lg:mb-0">
                  <div>
                    <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#007FFF]/10 border border-[#007FFF]/20 rounded-full text-xs font-bold text-[#007FFF] mb-6">
                      <Server size={12} /> Enterprise Systems
                    </div>
                    <h2 className="text-4xl md:text-5xl font-bold text-white mb-8 lg:mb-4">
                      Scalable systems. <br />
                    ...
                    <p className="text-lg text-[#B9BBBE] leading-relaxed">
                      ...
                      complex permission systems to automated background
                      workers, we handle the heavy lifting so you can scale.
                    </p>
                  </div>
                  <div className="flex flex-wrap gap-2">
              ...
              <div className="flex flex-col lg:flex-row lg:gap-20 items-center py-24 border-t border-white/5">
                ...
                <div className="lg:w-1/2 w-full space-y-6 mb-12 lg:mb-0">
                  <div>
                    <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#f97316]/10 border border-[#f97316]/20 rounded-full text-xs font-bold text-[#f97316] mb-6">
                      <Target size={12} /> Featured Case Study
                    </div>
                    <h2 className="text-4xl md:text-5xl font-bold text-white mb-8 lg:mb-4">
                      Mission critical <br />
                    ...
                    <p className="text-lg text-[#B9BBBE] leading-relaxed">
                      ...
                      offline-first mobile command center for managing
                      batteries, flight logs, and maintenance in the field.
                    </p>
                  </div>
                  <div className="flex flex-wrap gap-2">
                    {[
